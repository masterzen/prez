# Rudiments de technique photographique
...
<figure>
![L'appareil photo](resources/camera.png) <!-- .element width="50%" class="plain" -->
...
<figure>
![Capteur](resources/sensors.jpg) <!-- .element width="50%" class="plain" -->
...
<figure>
![Focale](resources/focal.png) <!-- .element width="50%" class="plain" -->
...
<figure>
![Diaphragme](resources/f-stop.png) <!-- .element width="50%" class="plain" -->
...
<figure>
![Profondeur de champ](resources/dof.png) <!-- .element width="45%" class="plain" -->
...
<figure>
![Profondeur de champ - exemple](resources/dof-example.jpg) <!-- .element width="65%" class="plain" -->
...
<figure>
![3 1/3](resources/three-tiers.jpg) <!-- .element width="55%" class="plain" -->
...
<figure>
![Lignes de fuites](resources/lignes-fuites.jpg) <!-- .element width="55%" class="plain" -->
...
<figure>
![regard](resources/regard2.jpg) <!-- .element width="47%" class="plain" -->
![regard](resources/regard.jpg) <!-- .element width="22%" class="plain" -->
...
<figure>
![regard](resources/foreground1.jpg) <!-- .element width="45%" class="plain" -->
![regard](resources/foreground2.jpg) <!-- .element width="45%" class="plain" -->
<figcaption>Regard</figcaption>
</figure>
