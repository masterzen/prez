...
note: au cours des 80s, commercialisation du Personnal Computer (PC)
...
![PCB](resources/pcb.jpg) <!-- .element width="75%" -->
...
<figure>
![PBT dye-sub](resources/pbt-dye-sub.jpg) <!-- .element width="50%" -->
...
<figure>
![ABS double shot](resources/abs-double-shot.jpg) <!-- .element width="50%" -->
...
![profiles](resources/profile.jpg) <!-- .element width="65%" -->
...
<figure>
![bepo](resources/Azerty_NFZ71-300.png) <!-- .element width="100%" -->
